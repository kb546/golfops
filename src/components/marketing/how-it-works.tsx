            ...
            return (
              ...
              >
                ...
                <div className="relative mx-auto mb-6">
                  <div className="w-16 h-16 mx-auto rounded-full bg-white border-2 border-emerald/20 flex items-center justify-center shadow-card relative z-10">
                ...
                <h3 className="text-lg font-bold text-charcoal font-heading mb-3">
                  {step.title}
                </h3>
