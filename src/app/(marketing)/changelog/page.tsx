    ...
    <div className="pt-[72px]">
      <section className="section-padding bg-white">
        <div className="container-marketing max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-[var(--color-text-primary)] font-heading leading-tight mb-4">
            What&apos;s New
          </h1>
            ...
            {updates.map((update) => (
              <article key={update.version} className="relative pl-8 border-l-2 border-emerald/20">
                ...
                <div className="mb-4">
                  ...
                  <span className="text-sm text-[var(--color-text-secondary)] ml-3">{update.date}</span>
                </div>
                <h2 className="text-xl font-bold text-[var(--color-text-primary)] font-heading mb-3">
                  {update.title}
                </h2>
                <ul className="space-y-2">
                  {update.changes.map((change) => (
                    <li key={change} className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-[var(--color-text-secondary)]">{change}</span>
                    </li>
                  ))}
                </ul>
              </article>
